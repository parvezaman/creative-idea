    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <div class="max-w-2xl mx-auto">
                            ...
                            <p class="mt-5">Creative Idea - Your Trusted Supplier
                            </p>
                ...
                <footer class="py-24 text-center text-sm text-black dark:text-white/70">
                    <p>
                        Level: #3, Shop: #313, Multiplan Computer City Centre, Eleplant Road, Dhaka
                    </p>

                    <p>
                        Cell: +880 1711 980 326; email: creativeidea2111@gmail.com
                    </p>
                </footer>
            </div>
        </div>
